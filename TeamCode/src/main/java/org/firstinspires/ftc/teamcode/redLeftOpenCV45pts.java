...
@TeleOp(name = "redLeftOpenCV45")

public class redLeftOpenCV45pts extends LinearOpMode {
    Hware robot;
    double cX = 0;
    double cY = 0;
    double width = 0;
